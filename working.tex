...
\begin{longtable}[t]{l>{\raggedright\arraybackslash}p{10em}l>{\raggedright\arraybackslash}p{26em}}
\caption{\label{tab:unnamed-chunk-1}\textbf{Cryptocurrency characteristics.} This caption is way too long and doesnt look good when formatted in the Table of Contents.  What you really need here is a much shorter caption so that your eyes dont go crazy trying to figure out what information the author is trying to convey.  Often there is too much information in the caption anyway so why not shorten it?. \label{tbl-characteristics}}\\
\toprule
