...
definitions <- tribble(
  ...
  # ---- Price and Size ----
  "mcap",        "Market capitalization",      "Market capitalization of the coin.",
  "prc",         "Price",                      "Cryptocurrency logged closing price.",
  "dh90",        "Closeness to the 90-day high", "Last day's price over the maximum price in the previous 90 days.",

  # ---- Volatility & Risk ----
  "beta",        "Market beta",                "CAPM market beta, estimated from 30 days of daily returns.",
  "ivol",        "Idiosyncratic volatility",   "Volatility of CAPM residuals over 30 days of daily returns.",
  "rvol_7d",     "7-day realized volatility",  "Realized volatility, calculated from 7 days of OHCL prices.",
  "rvol_30d",    "30-day realized volatility", "Realized volatility, calculated from 30 days of OHCL prices.",
  "retvol",      "Return volatility",          "Standard deviation of daily returns over 7 days.",
  "var",         "Value-at-Risk",              "The historical Value-at-Risk at 5\\% level over 90 days.",
  "delay",       "Price delay",                "Improvement in \\(R^2\\) after adding lagged one-and two-day market excecss return to the CAPM.",

  # ---- Activity ----
  "volume",      "Volume",                     "Daily trading volume.",
  "volume_7d",   "Average 7-day Volume",       "Mean volume over 7 days.",
  "volume_30d",  "Average 30-day Volume",      "Mean volume over 30 days.",
  "volscaled",   "Volume scaled by size",      "Trading volume scaled by market capitalization.",
  "turn",        "Turnover",                   "Turnover ratio (volume relative to market cap).",
  "std_vol",     "Volume standard deviation",  "Standard deviation of trading volume.",
  "cv_vol",      "Volume CV",                  "Coefficient of variation of trading volume.",

  # ---- Liquidity ----
  "bidask",      "Bid-ask spread",             "Bid-ask spread as a liquidity measure.",
  "illiq",       "Illiquidity",                "Amihud illiquidity ratio.",
  "sat",         "Supply-adjusted turnover",   "Turnover adjusted for circulating supply.",
  "dto",         "Dollar trading output",      "Total dollar trading value.",
  "volsh_30d",   "30-day volume share",        "Share of trading volume in the past 30 days.",

  # ---- Past Returns ----
  "r2_1",        "Daily reversal",             "Return on the previous trading day.",
  "r7_1",        "7-day momentum",             "7-day cumulative return ending 1 day before the prediction date.",
  "r14_1",       "14-day momentum",            "14-day cumulative return ending 1 day before the prediction date.",
  "r21_1",       "21-day momentum",            "21-day cumulative return ending 1 day before the prediction date.",
  "r30_1",       "30-day momentum",            "30-day cumulative return ending 1 day before the prediction date.",
  "r30_14",      "Intermediate momentum",         "Cumulative return from 30 to 14 days before the prediction date.",
  "r180_60",     "Long-term reversal",        "Cumulative return from 180 to 60 days before the prediction date.",
  "alpha",       "CAPM alpha",             "Jensen’s alpha estimated from a factor model.",

  # ---- Distribution ----
  "skew",        "Skewness",            "Skewness of daily returns over a 90-day period.",
  "kurt",        "Kurtosis",            "Kurtosis of daily returns over a 90-day period.",
  "maxret",      "Maximum daily return",             "Maximum daily return in the sample.",
  "minret",      "Minimum daily return",             "Minimum daily return in the sample."
)
