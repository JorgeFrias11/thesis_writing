...
\normalsize
    \begin{tabular}{ll}
        ...
        Date of Submission: & August 21, 2025
    \end{tabular}
    \vspace{2cm}
...
\hspace{1em}(3) & Closeness to the 90-day high & dh90 & Last day's price over the maximum price in the previous 90 \vphantom{1} days.\\
\addlinespace[0.3em]
...
\hspace{1em}NA & NA & volscaled & NA\\
\hspace{1em}(15) & Turnover & turn & The last day's trading volume over last day's market capitalization\\
...
\hspace{1em}(22) & Supply-adjusted turnover & sat & lag turn - average over its volatility\\
\hspace{1em}(23) & Dollar trading output & dto & Total dollar trading value.\\
\hspace{1em}(25) & 30-day volume share & volsh\_30d & Share of trading volume in the past 30 days.\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Panel E: Past returns}}\\
\hspace{1em}(26) & Daily reversal & r2\_1 & Return on the previous trading day.\\
\hspace{1em}(27-30) & *-day momentum & r7\_1 & 7, 14, 21, and 30-day cumulative return ending 1 day before the prediction date.\\
\hspace{1em}NA & NA & r14\_1 & NA\\
\hspace{1em}NA & NA & r21\_1 & NA\\
\hspace{1em}NA & NA & r30\_1 & NA\\
...
\hspace{1em}(33) & CAPM alpha & alpha & Jensen’s alpha estimated from a factor model.\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Panel F: Distribution}}\\
\hspace{1em}NA & NA & skew & NA\\
\hspace{1em}NA & NA & kurt & NA\\
\hspace{1em}NA & NA & maxret & NA\\
\hspace{1em}NA & NA & minret & NA\\
\bottomrule
\end{tabular}
\end{table}
...
\subsection{Price and size}\label{price-and-size}

\subsection{Volatility and risk}\label{volatility-and-risk}

\subsubsection{Realized volatility
(rvol)}\label{realized-volatility-rvol}
...
\subsection{Trading activity}\label{trading-activity}

\subsubsection{Volume shock}\label{volume-shock}
...
\subsubsection{Illiquidity}\label{illiquidity}

Moskowitz et al. (\citeproc{ref-moskowitzTimeSeriesMomentum2012}{2012})

\subsubsection{SAT}\label{sat}

\subsubsection{DTO}\label{dto}

\subsubsection{Volume shock}\label{volume-shock-1}
