...
\normalsize
    \begin{tabular}{ll}
        ...
        Date of Submission: & August 26, 2025
    \end{tabular}
    \vspace{2cm}
...
Merton (\citeproc{ref-mertonIntertemporalCapital1973}{1973}) and Ross
(\citeproc{ref-rossArbitrageTheory1976}{1976}). This motivates the
central question of this thesis: to what extent can the cross-section of
cryptocurrency returns be explained by systematic risk factors, and how
does this compare to the role of asset-specific characteristics in
predicting returns?

The purpose of this thesis is to \ldots{} study the research articles on
the theme to identify the relevant bibliometric trends such as
