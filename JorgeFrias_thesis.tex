...
\includegraphics[width=0.8\textwidth,height=\textheight]{pictures/timeseries_daily_coins.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{pictures/coins_per_year.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{pictures/sample_marketcap.png}
...
the Matplotlib package (v. 3.10.3; \citeproc{ref-Hunter:2007}{Hunter,
2007}).
...
\includegraphics{pictures/gammas_K2.png}
...
\includegraphics{pictures/gammas_K4.png}
...
(\citeproc{ref-liuCommonRisk2022}{2022}); Mercik et al.
(\citeproc{ref-mercikCrosssectionalInteractionsCryptocurrency2025}{2025});
Bianchi \& Babiak
(\citeproc{ref-bianchiMispricingRiskCompensation2021}{2021b})). Kelly et
al. (\citeproc{ref-kellyCharacteristicsAre2019}{2019}) introduce a
...
\includegraphics{pictures/chars_heatmap.png}
...
through their exposure to systematic risk. Moreover, the IPCA
performance remains strong in out-of-sample predictions. Both dynamic
models, pure latent or including observable factors, provide a better
...
to stylistically improve individual passages limited to linguistic
editing.
