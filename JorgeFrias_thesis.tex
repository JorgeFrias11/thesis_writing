...
model\$]{\label{fig-gammasK2}\textbf{Characteristic contribution in
2-factor model.} The figure shows the \(\Gamma_\beta\) coefficient
...
model]{\label{fig-gammasK4}\textbf{Characteristic contribution in
4-factor model.} The figure shows the \(\Gamma_\beta\) coefficient
