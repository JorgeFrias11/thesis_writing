...
directly from the panel of asset characteristics.

\section{IPCA model}\label{ipca-model}
...
For the restricted model, Equation~\ref{eq-ipca} can be rewritten in
vector form as
...
cross-sectional regressions on latent loadings (equation
\ref{eq-condition1}) and updating \(\Gamma_\beta\) through regressions
on factors interacted with characteristics (equation
\ref{eq-condition2}).
